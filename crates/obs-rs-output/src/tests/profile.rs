...
fn production_profile_presets_are_versioned_and_bounded() {
    ...
    assert_eq!(profiles[6].transport(), OutputTransport::SrtMpegTs);
    assert_eq!(profiles[7].video_codec(), OutputVideoCodec::Vp8);
    assert_eq!(profiles[7].audio_codec(), OutputAudioCodec::Opus);
