    ...
    ui.on_rename_scene(move || {
        ...
        apply_scene_properties_and_refresh(
            ...
            &ScenePropertiesDraft {
                ...
                transition_luma_pattern_index: ui.get_scene_transition_luma_pattern_index(),
                transition_luma_invert: ui.get_scene_transition_luma_invert(),
