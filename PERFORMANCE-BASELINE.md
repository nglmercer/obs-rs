...
| `cargo test -p obs-rs-gui --bin obs-rs-gui -- --test-threads=1` | Pass with explicit ignores | 99 pass; one compositor-dependent GUI test and one timing probe are ignored. |
